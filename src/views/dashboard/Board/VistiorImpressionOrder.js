      ...
      <CardContent sx={{ py: theme => `${theme.spacing(6.625)} !important` }}>
        <Box sx={{ my: 1.375, display: 'flex', alignItems: 'center' }}>
          ...
          <div>
            ...
            <Typography variant='body2'>Visiteurs aujourd’hui</Typography>
          </div>
        </Box>
      </CardContent>
      ...
      <CardContent sx={{ py: theme => `${theme.spacing(6.625)} !important` }}>
        <Box sx={{ my: 1.375, display: 'flex', alignItems: 'center' }}>
          ...
          <div>
            ...
            <Typography variant='body2'>Nouveaux Rendez-vous </Typography>
          </div>
        </Box>
      </CardContent>
    </Card>
...
export default VisitorImpressionOrder
